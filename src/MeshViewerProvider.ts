...
export class MeshViewerProvider implements vscode.CustomReadonlyEditorProvider<MeshDocument> {
    ...
    private static readonly viewType = 'vox.viewer';
    ...
    resolveCustomEditor(
        ...
        if(document.uri.scheme === 'file' && vscode.workspace.getConfiguration('vox').get('hotReload', true)) {
    ...
    private getScripts(scheme: string, nonce: string): string {
        const scripts = [
            ...
            this.getMediaPath(scheme, 'examples/js/loaders/VOXLoader.js'),
